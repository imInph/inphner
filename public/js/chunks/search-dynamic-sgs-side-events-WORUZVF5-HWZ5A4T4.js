import{a as R}from"./chunk-2F3GERFI.js";import{l as B,m as D}from"./chunk-C6IN5PZ4.js";import{c as A}from"./chunk-PGV3QAIX.js";import"./chunk-MXUW4ABC.js";var U=null;async function h(){return U??=e()}async function e(){return R(await B.kpuzzle(),`SubgroupSizes 24 21 18 15 12 9 6
...
Alg F D F' D L2 F R' F' D' B2 U'`)}async function t(){let{getPuzzleGeometryByName:l,ExperimentalPGNotation:g}=await import("./puzzle-geometry-7D5J2JX2.js"),L=l("megaminx",{allMoves:!0,addRotations:!0}),F=new A(L.getKPuzzleDefinition(!0),{experimentalPGNotation:new g(L,L.getOrbitsDef(!0))});return F.definition.name="megaminx",F}var n=null;async function a(){return n??=t()}var r=null;async function P(){return r??=i()}async function i(){return R(await a(),`SubgroupSizes 12 5 60 58 60 56 54 57 52 50 54 48 46 51 44 42 48 40 45 38 36 42 34 32 39 30 36 28 26 33 24 30 22 20 27 18 24 16 14 21 12 18 10 15 8 6 2 12 9 3
...
Alg U BR2' U R' U2' L U2 R U' BR2 U' L'`)}var u=null;async function o(){return u??=c()}async function b(){return{ordering:(await o()).ordering.slice(2)}}async function c(){return R(await D.pyraminx.kpuzzle(),`SubgroupSizes 12 9 12 3 10 3 8 6 2 3 3 3 3
...
Alg u
Alg u'`)}async function y(){let{getPuzzleGeometryByName:l,ExperimentalPGNotation:g}=await import("./puzzle-geometry-7D5J2JX2.js"),L=l("skewb",{allMoves:!0,addRotations:!0});return new A(L.getKPuzzleDefinition(!0),{experimentalPGNotation:new g(L,L.getOrbitsDef(!0))})}var s=null;async function m(){return s??=y()}var z=null;async function d(){return z??=f()}async function G(){return{ordering:(await d()).ordering.slice(1)}}async function f(){return R(await m(),`SubgroupSizes 24 6 5 12 9 3 4 9 3 3
...
//# sourceMappingURL=search-dynamic-sgs-side-events-WORUZVF5-HWZ5A4T4.js.map
